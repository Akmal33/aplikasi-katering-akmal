...
class CateringFinanceTracker:
    def __init__(self, excel_file="catering_finance_interactive.xlsx"):
...
def example_usage():
    ...
    print("=== CONTOH PENGGUNAAN APLIKASI KEUANGAN KATERING ===\n")
    ...
    print("1. Aplikasi mencatat setiap pemasukan dan pengeluaran dengan tanggal dan hari")
    print("2. Setiap transaksi baru akan menghitung saldo otomatis:")
    print("   Saldo Baru = Saldo Sebelumnya + Pemasukan - Pengeluaran")
    print("3. Pengguna dapat melihat laporan mingguan kapan saja")
    print("4. Semua data disimpan dalam file Excel untuk arsip")
