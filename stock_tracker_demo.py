...
def demo():
    """Demonstrate the functionality of the StockCardTracker"""
    print("=== Stock Card Tracker Demo ===\n")
    ...
    # Add a new stock entry
    print("Adding a new stock entry...")
    tracker.add_stock_entry("20/09/2025", "Pembelian bahan baku", 75, 0)
    
    # Add another entry
    print("\nAdding another stock entry...")
    tracker.add_stock_entry("22/09/2025", "Produksi selesai", 0, 40)
    
    # Display updated stock card
    print("\nUpdated Stock Card:")
    tracker.display_stock_card()
    
    # Show new balance
    new_balance = tracker.get_current_balance()
