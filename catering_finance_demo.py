...
class CateringFinanceTracker:
    def __init__(self, excel_file="catering_finance_demo.xlsx"):
...
def demo():
    """Demo aplikasi keuangan katering"""
    print("=== DEMO APLIKASI KEUANGAN KATERING ===\n")
    
    # Inisialisasi tracker
    tracker = CateringFinanceTracker()
    
    # Tambahkan beberapa data contoh
    print("Menambahkan data contoh...")
    
    # Pemasukan awal
    tracker.add_income("01/09/2025", "Senin", "Pembayaran pesanan nasi kotak", 1500000)
    tracker.add_income("02/09/2025", "Selasa", "Pembayaran catering harian", 2000000)
    tracker.add_income("03/09/2025", "Rabu", "Pembayaran catering pernikahan", 5000000)
    
    # Pengeluaran harian
    tracker.add_expense("01/09/2025", "Senin", "Belanja bahan baku", 300000)
    tracker.add_expense("01/09/2025", "Senin", "Biaya transportasi", 50000)
    tracker.add_expense("02/09/2025", "Selasa", "Belanja bahan baku", 350000)
    tracker.add_expense("02/09/2025", "Selasa", "Biaya gas dan listrik", 75000)
    tracker.add_expense("03/09/2025", "Rabu", "Belanja bahan baku", 400000)
    tracker.add_expense("03/09/2025", "Rabu", "Upah karyawan", 800000)
