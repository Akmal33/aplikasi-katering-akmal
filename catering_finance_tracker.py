...
class CateringFinanceTracker:
    def __init__(self, excel_file="catering_finance.xlsx"):
...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            description = input("Deskripsi pemasukan: ")
            try:
                amount = float(input("Jumlah pemasukan (Rp): "))
                tracker.add_income(date, day, description, amount)
            except ValueError:
            ...
            try:
                amount = float(input("Jumlah pengeluaran (Rp): "))
                tracker.add_expense(date, day, description, amount)
            except ValueError:
                print("Jumlah tidak valid!")
            ...
            print("Keluar tanpa menyimpan. Terima kasih!")
            break
